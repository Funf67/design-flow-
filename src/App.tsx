...
import { Calendar, Plus, Search, Settings, Globe } from 'lucide-react';
import { Button } from './components/ui/button';
import { Input } from './components/ui/input';
import { TaskModal } from './components/TaskModal/TaskModal';

function MainContent() {
  const { viewMode, setViewMode, t, language, setLanguage, searchQuery, setSearchQuery } = useAppContext();
